        ...
        <div className="flex items-center gap-8">
          ...
          <div className="relative">
            ...
            {isMenu && (
              ...
              >
                {user && user.email === "filip.bogicevic025@gmail.com" && (
                  <Link to={"/createItem"}>
        ...
        <div className="relative">
          ...
          {isMenu && (
            ...
            >
              ...
              <p
                onClick={logout}
                className="m-2 p-2 bg-gray-200 rounded-md shadow-md flex items-center gap-3 justify-center cursor-pointer hover:bg-gray-300 transition-all duration-100 ease-in-out text-textColor text-base"
              >
                Logout <MdLogout />
              </p>
            </motion.div>
